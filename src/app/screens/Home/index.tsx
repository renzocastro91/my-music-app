...
function App() {
  return (
    <main>
      ...
      <Artist name="Chaqueño P." category="Artista"  image ="https://www.lavanguardia.com/files/og_thumbnail/files/fp/uploads/2021/09/23/614ca532de6c8.r_d.3120-2080-0.jpeg" />
    </main>
  );
}
